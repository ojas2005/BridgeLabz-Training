...
namespace AddressBookApp.Models
{
    public class ContactDirectory : IContactRepository
    {
        ...
        private readonly Utilities.ThreadSafeLogger _logger = Utilities.ThreadSafeLogger.Instance;
        ...
        public void InsertContact(ContactPerson person)
        {
            lock (_lock)
            {
                ...
                catch (ArgumentNullException ex)
                {
                    ...
                    throw new Exceptions.ContactException("Failed to insert contact", ex);
                }
                catch (Exception ex)
                {
                    _logger.LogError("Unexpected error inserting contact", ex);
                    throw new Exceptions.ContactException("Unexpected error while inserting contact", ex);
                }
            }
        }
        ...
        public void SearchByCityOrState(string value)
        {
            lock (_lock)
            {
                ...
                catch (ArgumentException ex)
                {
                    ...
                    throw new Exceptions.ContactException("Search operation failed", ex);
                }
                catch (Exception ex)
                {
                    _logger.LogError("Unexpected error during search", ex);
                    throw new Exceptions.ContactException("Unexpected error during search", ex);
                }
            }
        }
        ...
        public void ViewPersonsByCity(string city)
        {
            lock (_lock)
            {
                ...
                catch (ArgumentException ex)
                {
                    ...
                    throw new Exceptions.ContactException("Failed to view persons by city", ex);
                }
                catch (Exception ex)
                {
                    _logger.LogError("Unexpected error viewing persons by city", ex);
                    throw new Exceptions.ContactException("Unexpected error viewing persons by city", ex);
                }
            }
        }
        ...
        public void ViewPersonsByState(string state)
        {
            lock (_lock)
            {
                ...
                catch (ArgumentException ex)
                {
                    ...
                    throw new Exceptions.ContactException("Failed to view persons by state", ex);
                }
                catch (Exception ex)
                {
                    _logger.LogError("Unexpected error viewing persons by state", ex);
                    throw new Exceptions.ContactException("Unexpected error viewing persons by state", ex);
                }
            }
        }
        ...
        public void EditContact(string firstName, string lastName)
        {
            lock (_lock)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new Exceptions.ContactException("Failed to update contact", ex);
                }
            }
        }
        ...
        public void DeleteContact(string firstName, string lastName)
        {
            lock (_lock)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new Exceptions.ContactException("Failed to delete contact", ex);
                }
            }
        }
        ...
        public void SortByFirstName()
        {
            lock (_lock)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new Exceptions.ContactException("Failed to sort by first name", ex);
                }
            }
        }
        ...
        public void SortByCity()
        {
            lock (_lock)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new Exceptions.ContactException("Failed to sort by city", ex);
                }
            }
        }
        ...
        public void SortByState()
        {
            lock (_lock)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new Exceptions.ContactException("Failed to sort by state", ex);
                }
            }
        }
        ...
        public void SortByZip()
        {
            lock (_lock)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new Exceptions.ContactException("Failed to sort by zip", ex);
                }
            }
        }
